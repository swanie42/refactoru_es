    ...
    return {
      activity : {
        ...
        materials:[
          ...
          {label : "Hardwood", show:["Clean", "Demo"]},
        ...
        actions:[
          ...
          {label : "Demo", show:["Frontloader", "Hand-tools"]},
          {label : "Cut-out", show:["Drywall-saw"]},
          {label : "Remove", show:["Hand-tools"]}
        ],
        methods:[
          {label : "Bleach", show:[""]},
          {label : "Water", show:[""]},
          {label : "Frontloader", show:[""]},
          {label : "Hand-tools", show:[""]},
          {label : "Drywall-saw", show:[""]},
          {label : "Shop-vac", show:[""]},
          {label : "HEPA vac", show:[""]}
        ],
      },
